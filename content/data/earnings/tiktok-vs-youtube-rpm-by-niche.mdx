...
**Beauty and skincare** tells a different story. While YouTube's AdSense RPM ($4.50) is solid, TikTok beauty creators benefit enormously from [TikTok Shop commissions](/calculators/tiktok-shop). Product-linked videos drive direct sales, and creators earn 10% to 20% commissions. When Shop revenue is factored in, TikTok's effective beauty RPM rises to $2.50, narrowing the YouTube advantage to 3.2x. For beauty creators who are strong at product promotion, TikTok can match or exceed YouTube's total revenue per view.
