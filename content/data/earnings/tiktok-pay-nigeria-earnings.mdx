...
metaDescription: "What TikTok pays Nigerian creators per 1,000 views in 2026 (NGN): low per-view RPM offset by 40M users, brand deals, live gifts, and affiliate income."
...
The [Creator Rewards Program](/calculators/tiktok-creator-fund/) succeeded the legacy Creator Fund, which paid Nigerian creators between ₦5 and ₦15 per 1,000 views (Fund-era rates). At the higher end, a viral video with 1 million views generated roughly ₦15,000 (about $10 USD) under the Fund. These rates place Nigeria among the lowest-paying markets on TikTok, primarily because advertiser spend in the Nigerian market is a fraction of what brands invest in North America or Europe. Qualifying Creator Rewards content (original videos over one minute) pays far more -- about $0.50 to $2.00 per 1,000 qualified views (US baseline; varies by market).
...
| View Count | Creator Fund (legacy) (NGN) | Brand Deals (NGN) | Live Gifts (NGN) | Total Estimated (NGN) | USD Equivalent |
|---|---|---|---|---|---|
...
Under the Creator Rewards Program, only original videos longer than one minute qualify for payouts, and that eligible long-form content earns significantly more than short-form clips. (Nigerian creators report that qualifying long-form content earns 2x to 3x the rate of videos under 60 seconds.) Note that the Fund-era rates above predate this requirement; the one-minute-original rule is specific to Creator Rewards. The program's eligibility rules -- 10,000 followers, 100,000 video views in the last 30 days, an account in good standing, and original 60-second-plus videos -- are published in [TikTok's official Creator Rewards documentation](https://support.tiktok.com/en/business-and-creator/creator-rewards-program). TikTok does not release per-country RPM figures, so the rates above are estimates from creator-reported data ([Miraflow, 2026](https://miraflow.ai/blog/tiktok-rpm-monetization-2026-how-much-tiktok-pays)).
...
**Comparison to other countries** highlights the earnings gap Nigerian creators face. A US-based creator earned roughly 5x to 10x more per 1,000 views from the legacy Creator Fund alone. However, Nigeria's lower cost of living means that even modest TikTok earnings can be locally significant. A creator earning ₦500,000 per month (roughly $320 USD) is well above the national average salary.

| Country | Legacy Fund RPM (USD/1K) | Avg. Brand Deal (Mid-Tier) | Cost of Living Context |
|---|---|---|---|
...
The Nigeria-specific earnings data in this article is compiled from publicly reported Nigerian creator earnings, brand-deal rate cards from Nigerian influencer marketing agencies, and TikTok's official Creator Rewards documentation, cross-referenced against our site-wide RPM and brand-deal models.
...
This data should be treated as informed estimates. Nigeria's TikTok creator economy is growing rapidly, and rates -- particularly for brand deals -- shift quarter over quarter. We review these figures every three months as new data becomes available.
...
Under the legacy Creator Fund, TikTok paid Nigerian creators approximately ₦5 to ₦15 per 1,000 views, which equals roughly $0.003 to $0.01 USD. The current Creator Rewards Program pays far more -- about $0.50 to $2.00 per 1,000 qualified views for original videos longer than one minute (US baseline; varies by market). The exact rate depends on video length (Creator Rewards requires videos over one minute), content category, and audience engagement. These Fund-era rates made Nigeria one of the lower-paying markets globally, primarily due to lower [advertising rates](/data/earnings/tiktok-advertising-rates-benchmarks/) in the region.
