...
The Money Gun is a mid-tier animated TikTok LIVE gift, and TikTok has revised its exact coin price over time — so rather than quote a figure that may be outdated in your region, calculate its value from the coin cost shown next to the gift in the LIVE gift tray. Multiply that coin figure by about **$0.0106** to get what a viewer pays, and by about **$0.0053** to get your Android payout (roughly 30% less on iOS). For example, a Money Gun priced at 500 coins would cost a viewer about $5.30 and return roughly $2.65 to you on Android. Drop the coin figure into the [Coins Calculator](/calculators/coins/) to get an exact dollar amount for the price you actually see.
