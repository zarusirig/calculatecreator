...
Effective February 1, 2026, TikTok Shop adjusted its commission structure. Creators now earn a flat 10% base commission on affiliate products (up from the previous 5-8% variable rate), with an additional 2-5% performance bonus for creators driving more than 100 sales per month. If you are running a shop, our [TikTok Shop profit calculator](/calculators/tiktok-shop) reflects the updated rates.
