...
## What Is RPM and How Does TikTok Calculate It?
          ...
          It&apos;s important to note that TikTok RPM specifically refers to earnings from TikTok&apos;s Creator Fund (now called the Creator Rewards Program in some regions). It does not include income from brand deals, LIVE gifts, affiliate marketing, or other monetization methods. Those revenue streams are tracked separately.
