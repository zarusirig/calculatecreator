...
metaDescription: "TikTok's 2026 Live ranking now weighs viewer retention and interaction quality over raw gift revenue, reshaping how live streams get discovered."
...
Previously, TikTok's live algorithm heavily weighted gift revenue as a ranking signal. Gift revenue comes from the coins-to-diamonds gifting system TikTok documents in its [LIVE Gifts support pages](https://support.tiktok.com/en/live-gifts-wallet/tiktok-live/live-gifts-on-tiktok), and streams generating the most gift income received the most prominent placement in the Live tab and For You Page live recommendations. The updated system reduces gift revenue's influence and introduces new signals that reward engaging content over pure monetization.
...
The updated algorithm distributes viewers more evenly across mid-tier streamers than the previous system, which concentrated viewers among the top gift earners. The ranges below are illustrative estimates based on creator-reported observation, not official TikTok data.
...
## Key Trends in Live Ranking Changes

A note on sourcing first: TikTok does not publish live-ranking weights or ecosystem-level revenue figures, and its [LIVE and Gifts help center](https://support.tiktok.com/en/live-gifts-wallet) describes features rather than ranking mechanics. The trends below are directional observations drawn from creator reports and third-party tracking, not official TikTok data, and ranking behavior can change at any time.

**Gift revenue appears less concentrated.** Creator reports suggest the top few percent of streamers now capture a smaller share of total gift revenue than they did a year or two ago, as mid-tier streamers pick up more of the gift economy.

**Average stream lengths appear to have grown.** Many creators report extending their sessions to accumulate the watch time the retention-focused system rewards, which lengthens the typical live session.

**New streamer visibility appears to have improved.** First-time live creators appear to receive a larger initial "test audience" than before, giving the algorithm more signal to evaluate stream quality before it decides whether to scale distribution.
