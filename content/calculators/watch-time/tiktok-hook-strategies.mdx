...
Open the retention graph in TikTok analytics. A cliff drop in the first 1-2 seconds means the hook itself is not stopping the scroll. A steep drop at 3-5 seconds means the hook worked but the content did not deliver on its promise. Compare against your [watch time metrics](/calculators/watch-time/watch-time-metrics-explained/) baseline to confirm the pattern.
