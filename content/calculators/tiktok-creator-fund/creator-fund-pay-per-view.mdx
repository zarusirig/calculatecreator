...
**Creator Fund (Legacy/Discontinued):** $0.02-$0.05 per 1,000 views. Fixed daily pool shared among all participants. No minimum video length requirement. Available in limited regions. Payments decrease as more creators join. Replaced by Creator Rewards in most markets.

**Creator Rewards (Current Active Program):** $0.50-$2.00 per 1,000 qualified views. Not based on a fixed pool. Requires videos of at least one minute. Evaluates content quality, search value, and originality. Available in more markets and expanding.
