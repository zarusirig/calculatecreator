...
The legacy TikTok Creator Fund paid just $0.02 to $0.05 per 1,000 views — and it is [now discontinued](https://support.tiktok.com/en/business-and-creator/creator-fund-us/creator-fund). The program that replaced it, the [Creator Rewards Program](/guides/creator-rewards-program/), pays an estimated $0.50 to $2.00 per 1,000 qualified views, roughly 10-40x more. Whichever figure you are modeling, the same four controllable levers decide where you land in the range: video length, content niche, audience geography, and engagement. This guide breaks down each with current data so you can maximize your TikTok view-based RPM in 2026.
...
**How to shift your audience geography:** Post during US peak hours (6–10 PM ET), use English captions, reference US-specific topics or cultural moments, and engage with US-based creators. Our [Creator Fund rates by country](/data/creator-fund-rates-by-country/) breakdown shows the full regional pattern.
...
Monitor your RPM weekly in TikTok Studio. The [Creator Rewards vs Creator Fund comparison](/calculators/tiktok-creator-fund/creator-rewards-vs-creator-fund/) explains how the two programs differ, and the full [how to increase view-based earnings](/guides/how-to-increase-creator-fund-earnings/) guide expands on each lever. For definitions, see [what TikTok RPM means](/calculators/rpm/what-is-tiktok-rpm/).
