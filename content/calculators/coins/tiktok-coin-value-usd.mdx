...
One TikTok coin is worth approximately $0.0106 USD in 2026. That puts the value of a single coin at just over one cent. The exact price per coin fluctuates slightly depending on the package size you purchase and the platform (iOS vs. Android), but $0.0106 is the baseline rate that holds across most standard transactions in the United States.
...
The conversion from coins to diamonds is where TikTok takes its primary cut. For every 100 coins a viewer spends on a gift (worth about $1.06), the creator earns roughly $0.53 in diamond value. This represents a roughly 50% revenue share, with TikTok retaining the other half. The exact ratio can vary slightly based on regional agreements and creator tier, but 50% is the standard baseline that most creators experience.
...
Understanding how much is 1 TikTok coin worth requires tracing the full path from viewer purchase to creator payout. The headline number — $0.0106 per coin — only tells part of the story. Creators do not receive $0.0106 for every coin spent on them. The actual creator payout per coin spent is roughly half that amount.
...
5. The creator earns roughly $0.50 in diamond value from that $1.00 in gifts
...
For creators calculating potential livestream earnings, this 50% rule of thumb is the critical number. If your stream receives 100,000 coins worth of gifts (about $1,060 in coin value), you earn approximately $530 before withdrawal fees — roughly 50% of the coins' value.
...
The minimum withdrawal threshold is $10, which requires accumulating at least 2,000 diamonds (new creators can withdraw from $1 / 200 diamonds). Once you hit this minimum, you can request a withdrawal at any time. TikTok processes withdrawals within a stated timeframe of 5-15 business days, up to 21 in some cases, though many creators report receiving funds faster than the maximum window.
...
- A **Drama Queen** (5,000 coins) earns approximately $26.50
- A **Universe** (34,999 coins) earns approximately $185.50
- A **Lion** (29,999 coins) earns approximately $159.00

These figures reflect the creator's approximately 50% share of the coin value after TikTok's commission.
