...
howToSteps:
  ...
  - name: "Research niche profitability and brand deal potential"
    text: "Compare RPM rates and average brand deal sizes across niches. Finance ($0.05-$0.08 RPM), tech ($0.04-$0.06), and beauty ($0.03-$0.05) are among the highest-paying niches for TikTok creators."
