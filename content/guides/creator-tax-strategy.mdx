...
To avoid underpayment penalties, pay the smaller of 90% of the current year's tax or the "safe harbor" of 100% of last year's tax (110% if your prior-year AGI exceeded $150,000). Estimate your quarterly amount with the [Creator Tax Calculator](/calculators/utility-tools/tax/).
...
- [Brand Deal Rate Data — industry benchmarks for sponsorship income](/data/brand-deal-rates-by-followers/)
