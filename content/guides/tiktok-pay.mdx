...
childArticles:
  - "/guides/tiktok-pay-per-1-million-views/"
relatedArticles:
...
These figures cover view-based pay only. A single video with 1,000,000 views might earn $500–$2,000 from Creator Rewards, but the creator behind it often earns several times more from a brand deal tied to the same content. For a full breakdown of the million-view case, see the dedicated guide on [how much TikTok pays per 1 million views](/guides/tiktok-pay-per-1-million-views/). To model a specific view count against your own niche and country, use the [Creator Fund Calculator](/calculators/tiktok-creator-fund/).
...
The other streams run on their own clocks. LIVE gift earnings can be withdrawn once you clear the diamond threshold — as low as **$1** (200 diamonds) for new creators and **$10** (2,000 diamonds) for established accounts — with processing that typically takes 5–15 business days. TikTok Shop pays on a **biweekly cycle** once an order clears its return window. Your **first withdrawal** on any program can take an extra 7–10 business days while TikTok verifies your identity and payout details — a normal delay, not a problem. If a payment is overdue past that window, the [TikTok payment delays guide](/guides/tiktok-payment-delays/) walks through the common causes.
