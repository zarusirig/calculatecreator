...
**Earnings potential.** TikTok's Creator Rewards Program pays different rates based on viewer location — roughly $0.50-$2.00 per 1,000 US views (the legacy Creator Fund paid $0.02-$0.05), while views from lower-CPM countries may pay $0.05-$0.15 per 1,000. A creator with 80% US traffic earns significantly more per view than one with 80% Southeast Asian traffic. Use the [TikTok money calculator](/calculators/tiktok-money/) to estimate earnings based on your audience geography.
...
Yes, significantly. TikTok's Creator Rewards Program pays different rates based on viewer geography — US views earn roughly 8-10x more per 1,000 views than views from Southeast Asia or South America. Age matters for sponsorships: brands pay 2-3x more to reach the 25-34 age bracket compared to the 13-17 bracket. Gender skew determines which brand categories are viable for your account.
