...
- A **[Galaxy](/data/reference/how-much-is-a-galaxy-on-tiktok/) (1,000 coins)** costs a viewer about **$10.60** and returns the creator about **$5.30** on Android.
...
Reading the chart: the creator column assumes roughly $0.0053 per coin on Android, and on iOS you should reduce those figures by about 30%. For the complete lookup and payout notes, see the [LIVE gifts value chart](/data/reference/live-gifts-value-chart/).
