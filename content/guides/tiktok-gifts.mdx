...
- **Diamonds** are what creators accrue. When a viewer sends a gift, TikTok credits the creator in diamonds, not coins, and diamonds are worth about **half** of the coins spent. They cash out at 200 diamonds = $1.
...
- **Step 1 — Coins to diamonds:** Gift coins x 0.5 = diamonds received.
- **Step 2 — Diamonds to cash:** Diamonds ÷ 200 = USD earned.
- **Combined:** (Gift coins x 0.5) ÷ 200 = USD earned on the creator side.

A practical Android rule of thumb is that a creator earns about **$0.0053 per coin** gifted, which means **1,000 coins is worth roughly $5.30** in creator earnings. That anchor is the fastest way to estimate a stream's value in your head: multiply thousands of coins by about $5.30.
