...
- **Combine gifts with other income.** LIVE gifting pairs well with the Creator Rewards Program and brand deals — see the [seven ways to make money on TikTok](/learn/seven-ways-make-money-tiktok/) for how the streams fit together.

For platform limits that affect LIVE eligibility, review the [TikTok video length limits](/learn/tiktok-video-length-limits/) reference, and browse the full [reference data hub](/learn/reference/) for related payout mechanics.
