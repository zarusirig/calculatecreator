...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://ttcalculator.net/news/retention-metrics-priority/',
  },
};
    ...
    <>
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Retention Metrics Priority', url: 'https://ttcalculator.net/news/retention-metrics-priority/' },
        ]}
      />
