    ...
    <div className="min-h-screen bg-neutral-50">
      ...
      <div className="container-custom max-w-4xl py-12 space-y-8">
        ...
        <Card>
          ...
          <p className="text-body-md text-neutral-700 mb-4">
            TikTok Shop's 2025 holiday campaign represents the platform's largest-ever investment in social commerce. With enhanced features, bigger creator incentives, and unprecedented promotional support, this season positions TikTok Shop as a legitimate competitor to Amazon and traditional retail.
          </p>
