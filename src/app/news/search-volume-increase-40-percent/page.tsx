...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://ttcalculator.net/news/search-volume-increase-40-percent/',
  },
};
    ...
    <>
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Search Volume Growth', url: 'https://ttcalculator.net/news/search-volume-increase-40-percent/' },
        ]}
      />
      ...
      <div className="container-custom max-w-4xl py-12 space-y-8">
        ...
        <Card className="bg-gradient-to-br from-primary-50 to-secondary-50">
          ...
          <div className="grid md:grid-cols-2 gap-3">
            ...
            <Link
              href="/learn/tiktok-hashtag-strategy-2026/"
              className="flex items-center justify-between p-4 bg-white rounded-lg border-2 border-transparent hover:border-primary-500 transition-colors"
            >
