...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://ttcalculator.net/news/tiktok-ban-delayed-december-2025/',
  },
};
  ...
  return (
    <>
      <NewsArticleSchema
        ...
        url="https://ttcalculator.net/news/tiktok-ban-delayed-december-2025/"
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: 'TikTok Ban Delayed', url: 'https://ttcalculator.net/news/tiktok-ban-delayed-december-2025/' },
        ]}
      />
