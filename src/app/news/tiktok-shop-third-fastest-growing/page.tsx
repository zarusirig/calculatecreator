...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://ttcalculator.net/news/tiktok-shop-third-fastest-growing/',
  },
};
    ...
    <>
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: 'TikTok Shop Growth', url: 'https://ttcalculator.net/news/tiktok-shop-third-fastest-growing/' },
        ]}
      />
