...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://ttcalculator.net/news/parent-safety-features-update/',
  },
};
    ...
    <>
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Parent Safety Features', url: 'https://ttcalculator.net/news/parent-safety-features-update/' },
        ]}
      />
