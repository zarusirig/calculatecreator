  ...
  const faqs = [
    {
      ...
      answer: '**Finance (FinTok) consistently pays the highest, with RPM rates 3 to 5 times above average ($0.05 to $0.07 per 1K views versus $0.01 to $0.02 for entertainment).** Brand deals pay 2 to 3 times higher than entertainment niches. A 100K finance creator earns $3,000 to $5,000 per sponsored post while a 100K entertainment creator gets $1,000 to $1,500. This premium stems from high customer lifetime values ($500 to $5,000+ per user) for finance products like credit cards, investment apps, and banking services. B2B and professional education niches also command premium rates, often 2 to 4 times standard niche averages.',
    },
    {
      question: 'Can I switch niches to earn more?',
      answer: '**Yes, but strategic niche blending is usually smarter than complete pivots.** A comedy creator adds "personal finance comedy" or "money memes" content to tap into higher-paying advertisers while keeping their existing audience engaged. Pure niche pivots risk losing 30% to 50% of followers who followed for your original content. Test new content types with 5 to 10 videos first to gauge audience reception. Gradually increase the ratio over 2 to 3 months when engagement holds steady or improves. Document your transition journey as content. "Why I am pivoting to finance content" videos often perform well and help bring your audience along.',
    },
    {
