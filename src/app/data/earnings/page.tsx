...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://ttcalculator.net/data/earnings/' },
};
...
export default function EarningsDataHubPage() {
  ...
  return (
    <>
      <FAQPageSchema faqs={earningsFaqs} url="https://ttcalculator.net/data/earnings/" />
      <HubListingPage
          ...
          <>
            ...
            <ul className="mt-3 list-disc pl-5 text-body-md text-neutral-700 space-y-2">
              <li>
                ...
                grade your payouts:{' '}
                <Link href="/data/earnings/average-tiktok-earnings-per-views/" className="text-primary-700 hover:text-primary-800">
                  average TikTok earnings per 1K, 10K, 100K, and 1M views
                </Link>
                , the{' '}
                <Link href="/data/earnings/tiktok-creator-income-distribution/" className="text-primary-700 hover:text-primary-800">
                  TikTok creator income distribution
                </Link>
                , the{' '}
                <Link href="/data/earnings/tiktok-earnings-growth-timeline/" className="text-primary-700 hover:text-primary-800">
                  TikTok earnings growth timeline
                </Link>
                ,{' '}
                <Link href="/data/earnings/fulltime-vs-parttime-creator-earnings/" className="text-primary-700 hover:text-primary-800">
                  full-time vs part-time TikTok creator earnings
                </Link>
                , and{' '}
                <Link href="/data/earnings/seasonal-tiktok-earnings-trends/" className="text-primary-700 hover:text-primary-800">
              ...
              <li>
                ...
                <Link href="/data/earnings/tiktok-pay-us-earnings/" className="text-primary-700 hover:text-primary-800">
                  how much TikTok pays in the US
                </Link>
                ,{' '}
                <Link href="/data/earnings/tiktok-pay-uk-earnings/" className="text-primary-700 hover:text-primary-800">
                  in the UK
                </Link>
                , and{' '}
                <Link href="/data/earnings/tiktok-pay-germany-earnings/" className="text-primary-700 hover:text-primary-800">
                  in Germany
                </Link>
              ...
              <li>
                ...
                <Link href="/data/earnings/tiktok-creator-economy-size/" className="text-primary-700 hover:text-primary-800">
                  TikTok creator economy size
                </Link>
                ,{' '}
                <Link href="/data/earnings/tiktok-shop-gmv-growth/" className="text-primary-700 hover:text-primary-800">
                  TikTok Shop GMV growth
                </Link>
                ,{' '}
                <Link href="/data/earnings/tiktok-advertising-rates-benchmarks/" className="text-primary-700 hover:text-primary-800">
                  TikTok advertising rates
                </Link>
                ,{' '}
                <Link href="/data/earnings/tiktok-vs-youtube-rpm-by-niche/" className="text-primary-700 hover:text-primary-800">
                  TikTok vs YouTube RPM comparison by niche
                </Link>
                , and{' '}
                <Link href="/data/earnings/top-tiktok-creators-income/" className="text-primary-700 hover:text-primary-800">
