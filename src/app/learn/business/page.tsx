...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://ttcalculator.net/learn/business/' },
};
...
export default function BusinessHubPage() {
  ...
  return (
    <>
    <FAQPageSchema faqs={businessFaqs} url="https://ttcalculator.net/learn/business/" />
    <HubListingPage
        ...
        <>
          ...
          <ul className="mt-3 list-disc pl-5 text-body-md text-neutral-700 space-y-2">
            <li>
              ...
              <Link href="/learn/tiktok-creator-taxes-guide/" className="text-primary-700 hover:text-primary-800">
                TikTok creator taxes guide by country
              </Link>{' '}
              covers what to set aside, the{' '}
              <Link href="/learn/international-creator-tax-implications/" className="text-primary-700 hover:text-primary-800">
                cross-border tax implications
              </Link>{' '}
              guide covers foreign income, and{' '}
              <Link href="/learn/tiktok-creator-insurance/" className="text-primary-700 hover:text-primary-800">
            ...
            <li>
              ...
              <Link href="/learn/brand-deal-contract-negotiate/" className="text-primary-700 hover:text-primary-800">
                brand deal contract essentials
              </Link>
              ,{' '}
              <Link href="/learn/ftc-disclosure-tiktok/" className="text-primary-700 hover:text-primary-800">
                FTC disclosure requirements
              </Link>
              ,{' '}
              <Link href="/learn/tiktok-copyright-fair-use/" className="text-primary-700 hover:text-primary-800">
                copyright and fair use on TikTok
              </Link>
              ,{' '}
              <Link href="/learn/tiktok-intellectual-property-protection/" className="text-primary-700 hover:text-primary-800">
                TikTok intellectual property protection
              </Link>
              , and{' '}
              <Link href="/learn/tiktok-community-guidelines-strikes/" className="text-primary-700 hover:text-primary-800">
            ...
            <li>
              ...
              <Link href="/learn/when-to-hire-manager-tiktok/" className="text-primary-700 hover:text-primary-800">
                when to hire a manager
              </Link>
              ,{' '}
              <Link href="/learn/tiktok-creator-burnout-guide/" className="text-primary-700 hover:text-primary-800">
                creator burnout signs and recovery
              </Link>
              , and{' '}
              <Link href="/learn/tiktok-exit-strategies/" className="text-primary-700 hover:text-primary-800">
          ...
          <p className="mt-3 text-body-md text-neutral-700">
            ...
            <Link href="/learn/creator-tax-strategy/" className="text-primary-700 hover:text-primary-800">
            ...
            <Link href="/learn/llc-for-tiktok-creators/" className="text-primary-700 hover:text-primary-800">
