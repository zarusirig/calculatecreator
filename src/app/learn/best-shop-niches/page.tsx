...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://ttcalculator.net/learn/best-shop-niches/',
  },
};
  ...
  return (
    <>
      <ArticleSchema
        ...
        url="https://ttcalculator.net/learn/best-shop-niches/"
      ...
      <div className="min-h-screen bg-neutral-50">
        ...
        <div className="container-custom">
          <div className="flex items-center space-x-2 text-body-sm text-neutral-600">
            ...
            <Link href="/learn/">Guides</Link><span>/</span>
      ...
      <div className="container-custom max-w-5xl py-12 space-y-8">
        ...
        <Card>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <Link href="/learn/reference/" className="p-4 bg-neutral-50 rounded-lg hover:bg-neutral-100">
            ...
            <Link href="/learn/tiktok-live-shopping/" className="p-4 bg-neutral-50 rounded-lg hover:bg-neutral-100">
