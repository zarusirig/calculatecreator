...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://ttcalculator.net/learn/tiktok-growth-hub/',
  },
  openGraph: {
    ...
    type: 'article',
    url: 'https://ttcalculator.net/learn/tiktok-growth-hub/',
    ...
    <>
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: 'TikTok Growth Hub', url: 'https://ttcalculator.net/learn/tiktok-growth-hub/' },
        ]}
      />
        ...
        <div className="container-custom">
          <Breadcrumb
            items={[
              ...
              { label: 'TikTok Growth Hub', href: '/learn/tiktok-growth-hub/' },
            ]}
          />
          ...
          <div className="max-w-4xl mx-auto space-y-12">
                  ...
                  <div>
                    ...
                    <div className="p-6 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-lg border-2 border-blue-200">
                      ...
                      <div className="mt-4 text-center">
                        <Link href="/learn/how-to-increase-engagement/">
            ...
            <section id="content-strategy">
              <Card>
                ...
                <div className="space-y-6">
                  ...
                  <div className="p-4 bg-green-50 rounded-lg">
                    <p className="text-sm text-neutral-700">
                      Dive deeper into content planning with our <Link href="/learn/content-strategy-2025/" className="text-primary-600 underline">Content Strategy guide</Link>. Not sure what niche to focus on? Use our <Link href="/learn/niche-selection/" className="text-primary-600 underline">Niche Selection guide</Link> and the <Link href="/calculators/niche-profitability/" className="text-primary-600 underline">Niche Profitability Calculator</Link> to find the most profitable content direction.
                    </p>
                  </div>
                </div>
              </Card>
            ...
            <section id="growth-roadmap">
              <Card>
                ...
                <div className="space-y-6">
                  ...
                  <div className="p-4 bg-blue-50 rounded-lg">
                    <p className="text-sm text-neutral-700">
                      For getting your first 1,000 followers fast, check our guide on <Link href="/learn/how-to-get-1000-followers-live/" className="text-primary-600 underline">how to get 1,000 followers through LIVE</Link>. Explore monetization options at each tier with the <Link href="/learn/monetization-calculator-hub/" className="text-primary-600 underline">Monetization Calculator Hub</Link>.
                    </p>
                  </div>
                </div>
              </Card>
            ...
            <Card>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <Link href="/learn/how-to-go-viral-tiktok/" className="p-4 bg-neutral-50 rounded-lg hover:bg-neutral-100">
                ...
                <Link href="/learn/tiktok-algorithm-explained/" className="p-4 bg-neutral-50 rounded-lg hover:bg-neutral-100">
                ...
                <Link href="/learn/how-to-increase-engagement/" className="p-4 bg-neutral-50 rounded-lg hover:bg-neutral-100">
                ...
                <Link href="/learn/content-strategy-2025/" className="p-4 bg-neutral-50 rounded-lg hover:bg-neutral-100">
