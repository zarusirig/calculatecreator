...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://ttcalculator.net/learn/tiktok-ads-hub/',
  },
  openGraph: {
    ...
    type: 'article',
    url: 'https://ttcalculator.net/learn/tiktok-ads-hub/',
    ...
    <>
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: 'TikTok Ads Hub', url: 'https://ttcalculator.net/learn/tiktok-ads-hub/' },
        ]}
      />
        ...
        <div className="container-custom">
          <Breadcrumb
            items={[
              ...
              { label: 'TikTok Ads Hub', href: '/learn/tiktok-ads-hub/' },
            ]}
          />
          ...
          <div className="max-w-4xl mx-auto space-y-12">
              ...
              <Card>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="mt-4 p-4 bg-yellow-50 rounded-lg">
                      <p className="text-sm text-neutral-700">
                        Learn more about pricing Spark Ads deals in our <Link href="/learn/spark-ads-for-creators/" className="text-primary-600 underline">Spark Ads for Creators guide</Link>, and use the <Link href="/calculators/sponsorship-roi/" className="text-primary-600 underline">Sponsorship ROI Calculator</Link> to evaluate deal profitability. For general brand deal pricing, see our <Link href="/learn/brand-deals/" className="text-primary-600 underline">pricing guide</Link>.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <Card>
                ...
                <div className="space-y-6">
                  ...
                  <div className="p-4 bg-blue-50 rounded-lg">
                    <p className="text-sm text-neutral-700">
                      Compare TikTok ad performance against other platforms using our <Link href="/learn/platform-comparisons/" className="text-primary-600 underline">TikTok vs Instagram comparison</Link>. For niche-specific ad rate data, check our <Link href="/learn/rpm-rates-by-niche/" className="text-primary-600 underline">RPM rates by niche</Link> and <Link href="/learn/brand-deal-rates-by-niche/" className="text-primary-600 underline">brand deal rates by niche</Link> datasets.
                    </p>
                  </div>
                </div>
              </Card>
            ...
            <section id="ads-roadmap">
              <Card>
                ...
                <div className="space-y-6">
                  ...
                  <div className="mt-4 p-4 bg-blue-50 rounded-lg">
                    <p className="text-sm text-neutral-700">
                      For a comprehensive budget planning deep dive, read our <Link href="/learn/tiktok-ad-budget-calculator-guide/" className="text-primary-600 underline">TikTok Ad Budget Calculator Guide</Link>. For brand deal and influence valuation, check the <Link href="/learn/calculating-true-influence-value/" className="text-primary-600 underline">Calculating True Influence Value guide</Link>. View <Link href="/learn/earnings/" className="text-primary-600 underline">regional ad data</Link> for country-specific benchmarks.
                    </p>
                  </div>
                </div>
              </Card>
            ...
            <Card>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <Link href="/learn/tiktok-ad-budget-calculator-guide/" className="p-4 bg-neutral-50 rounded-lg hover:bg-neutral-100">
                ...
                <Link href="/learn/spark-ads-for-creators/" className="p-4 bg-neutral-50 rounded-lg hover:bg-neutral-100">
                ...
                <Link href="/learn/tiktok-shop-success-strategies/" className="p-4 bg-neutral-50 rounded-lg hover:bg-neutral-100">
                ...
                <Link href="/learn/monetization-calculator-hub/" className="p-4 bg-neutral-50 rounded-lg hover:bg-neutral-100">
