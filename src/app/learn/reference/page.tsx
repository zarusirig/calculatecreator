...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://ttcalculator.net/learn/reference/' },
};
...
export default function ReferenceDataHubPage() {
  ...
  return (
    <>
    <FAQPageSchema faqs={referenceFaqs} url="https://ttcalculator.net/learn/reference/" />
    <HubListingPage
      ...
      supplementaryContent={
        <>
          ...
          <p className="mt-3 text-body-md text-neutral-700">
            ...
            <Link href="/calculators/payout/" className="text-primary-700 hover:text-primary-800">
              payout calculator
            </Link>{' '}
            and{' '}
          ...
          <p className="mt-3 text-body-md text-neutral-700">
            ...
            <Link href="/learn/creator-fund-countries/" className="text-primary-700 hover:text-primary-800">
              Creator Rewards Program countries
            </Link>, the{' '}
            <Link href="/learn/shop-commission-rates/" className="text-primary-700 hover:text-primary-800">
              Shop commission rates
            </Link>, the{' '}
            <Link href="/learn/shop-payment-schedule/" className="text-primary-700 hover:text-primary-800">
              Shop payment schedule
            </Link>, and the{' '}
            <Link href="/learn/live-gifts-value-chart/" className="text-primary-700 hover:text-primary-800">
          ...
          <p className="mt-3 text-body-md text-neutral-700">
            ...
            <Link href="/learn/tiktok-video-length-limits/" className="text-primary-700 hover:text-primary-800">
              TikTok video length limits and recommendations
            </Link>{' '}
            page defines format ceilings by account type, the{' '}
            <Link href="/learn/tiktok-business-vs-creator-account/" className="text-primary-700 hover:text-primary-800">
              TikTok Business vs Creator account
            </Link>{' '}
            comparison explains feature differences, and{' '}
            <Link href="/learn/how-much-is-a-galaxy-on-tiktok/" className="text-primary-700 hover:text-primary-800">
