...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://ttcalculator.net/learn/monetization/' },
};
...
export default function MonetizationHubPage() {
  ...
  return (
    <>
    <FAQPageSchema faqs={monetizationFaqs} url="https://ttcalculator.net/learn/monetization/" />
    <HubListingPage
        ...
        <>
          ...
          <ul className="mt-3 list-disc pl-5 text-body-md text-neutral-700 space-y-2">
            <li>
              ...
              <Link href="/learn/seven-ways-make-money-tiktok/" className="text-primary-700 hover:text-primary-800">
                7 ways to make money on TikTok ranked by income potential
              </Link>{' '}
              compares every option,{' '}
              <Link href="/learn/micro-influencers-make-money-tiktok/" className="text-primary-700 hover:text-primary-800">
                how micro-influencers under 10K make money
              </Link>{' '}
              covers small accounts, and{' '}
              <Link href="/learn/tiktok-monetization-by-country/" className="text-primary-700 hover:text-primary-800">
            ...
            <li>
              ...
              <Link href="/learn/tiktok-series-monetization/" className="text-primary-700 hover:text-primary-800">
                TikTok Series monetization
              </Link>
              ,{' '}
              <Link href="/learn/tiktok-subscription-recurring-revenue/" className="text-primary-700 hover:text-primary-800">
                the TikTok subscription feature
              </Link>
              ,{' '}
              <Link href="/learn/tiktok-affiliate-without-shop/" className="text-primary-700 hover:text-primary-800">
                TikTok affiliate marketing without TikTok Shop
              </Link>
              , and{' '}
              <Link href="/learn/get-paid-faster-tiktok/" className="text-primary-700 hover:text-primary-800">
            ...
            <li>
              ...
              <Link href="/learn/selling-digital-products-tiktok/" className="text-primary-700 hover:text-primary-800">
                selling digital products through TikTok
              </Link>
              ,{' '}
              <Link href="/learn/tiktok-course-creation-guide/" className="text-primary-700 hover:text-primary-800">
                TikTok course creation
              </Link>
              ,{' '}
              <Link href="/learn/tiktok-merch-strategies/" className="text-primary-700 hover:text-primary-800">
                TikTok merch strategies
              </Link>
              ,{' '}
              <Link href="/learn/tiktok-consulting-creator/" className="text-primary-700 hover:text-primary-800">
                TikTok consulting
              </Link>
              , and{' '}
              <Link href="/learn/passive-income-tiktok-creators/" className="text-primary-700 hover:text-primary-800">
            ...
            <li>
              ...
              <Link href="/learn/diversify-tiktok-income-streams/" className="text-primary-700 hover:text-primary-800">
                how to diversify TikTok income streams
              </Link>{' '}
              and{' '}
              <Link href="/learn/financial-planning-tiktok-creators/" className="text-primary-700 hover:text-primary-800">
          ...
          <p className="mt-3 text-body-md text-neutral-700">
            ...
            <Link href="/learn/tiktok-creator-fund/" className="text-primary-700 hover:text-primary-800">
              TikTok Creator Fund guide
            </Link>{' '}
            and the full eligibility breakdown in our{' '}
            <Link href="/learn/tiktok-monetization-requirements/" className="text-primary-700 hover:text-primary-800">
