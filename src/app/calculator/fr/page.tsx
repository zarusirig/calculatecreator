  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-neutral-50 via-white to-success-light py-8">
        <div className="container-custom">
          ...
          <Link href="/learn/earnings/" className="text-neutral-600 hover:text-primary-600">Statistiques Mondiales TikTok</Link>
          <span className="text-neutral-400">→</span>
        ...
        <div className="max-w-4xl mx-auto text-center mb-12">
          ...
          <div className="mt-4">
            <Link href="/learn/earnings/" className="inline-flex items-center space-x-2 text-body-sm text-primary-600 hover:text-primary-700">
