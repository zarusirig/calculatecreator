      ...
      supplementaryContent={
        <>
          ...
          <p className="mt-3 text-body-md text-neutral-700">
            ...
            <Link href="/guides/niche-selection/" className="text-primary-700 hover:text-primary-800">
              TikTok niche selection guide
            </Link>{' '}
            and the{' '}
            <Link href="/data/engagement-rates-by-niche/" className="text-primary-700 hover:text-primary-800">
