...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://ttcalculator.net/calculators/shop-profit/',
  },
  openGraph: {
    url: 'https://ttcalculator.net/calculators/shop-profit/',
    type: 'website',
    ...
    <div className="min-h-screen bg-gradient-to-br from-neutral-50 via-white to-info-light py-8">
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Shop Commission Calculator', url: 'https://ttcalculator.net/calculators/shop-profit/' },
        ]}
      />
      <FAQSchema faqs={faqData} />
      <div className="container-custom">
        <Breadcrumb items={[{ label: 'Calculators', href: '/calculators/' }, { label: 'Shop Commission Calculator', href: '/calculators/shop-profit/' }]} />
        ...
        <div className="max-w-4xl mx-auto text-center mb-12">
          ...
          <p className="text-body-md text-neutral-600 max-w-2xl mx-auto">
            Learn <Link href="/learn/tiktok-shop-affiliate/" className="text-primary-600 hover:text-primary-700 underline font-medium transition-colors">how the TikTok Shop affiliate program works</Link> or explore <Link href="/learn/tiktok-shop-success-strategies/" className="text-primary-600 hover:text-primary-700 underline font-medium transition-colors">TikTok Shop success strategies</Link> to maximize your commissions.
          </p>
        </div>
...
Annual Earnings: $120 × 12 = $1,440`}
          ...
          <RelatedGuides calculatorPath="/calculators/shop-profit" />
