...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://ttcalculator.net/featured/engagement-rate-1600.webp', width: 1600, height: 1067, alt: 'TikTok Engagement Rate Calculator — creator workspace scene illustrating the topic' }],
  },
};
        ...
        <div className="container-custom">
          ...
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-body-md text-neutral-600 mt-4 max-w-2xl mx-auto">
              Learn <Link href="/learn/how-to-increase-engagement/" className="text-primary-600 hover:text-primary-700 underline">proven strategies to increase your engagement rate</Link> or understand <Link href="/learn/tiktok-algorithm-explained/" className="text-primary-600 hover:text-primary-700 underline">how engagement affects the algorithm</Link>.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <ToolExplanationSection
              ...
              relatedContent={[
                ...
                { title: 'How to Increase Engagement Rate', href: '/learn/how-to-increase-engagement/' },
              ]}
            />
