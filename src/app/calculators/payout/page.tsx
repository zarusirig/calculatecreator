  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-neutral-50 via-white to-primary-50 py-8">
        ...
        <Breadcrumb items={[
          ...
          { label: 'Payout Calculator', href: '/calculators/payout/' }
        ]} />
          ...
          <div className="mt-12">
            ...
            <ToolExplanationSection
              ...
              relatedContent={[
                ...
                { title: 'Tax Calculator', href: '/calculators/tax/' },
