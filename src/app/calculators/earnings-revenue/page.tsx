...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://ttcalculator.net/featured/earnings-revenue-1600.webp', width: 1600, height: 1067, alt: 'TikTok Earnings & Revenue Calculator for Creators — creator workspace scene illustrating the topic' }],
  },
};
