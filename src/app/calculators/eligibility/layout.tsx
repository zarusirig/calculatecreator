...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://ttcalculator.net/calculators/eligibility/',
  },
  openGraph: {
    url: 'https://ttcalculator.net/calculators/eligibility/',
    type: 'website',
    siteName: 'TT Calculator',
    images: [{ url: 'https://ttcalculator.net/featured/eligibility-1600.webp', width: 1600, height: 1067, alt: 'Creator Fund Calculator — creator workspace scene illustrating the topic' }],
  },
};
    ...
    <>
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Eligibility Checker', url: 'https://ttcalculator.net/calculators/eligibility/' }
        ]}
      />
      {children}
    </>
