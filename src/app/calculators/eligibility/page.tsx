  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-neutral-50 via-white to-success-50 py-8">
        ...
        <Breadcrumb items={[
          ...
          { label: 'Eligibility Checker', href: '/calculators/eligibility/' }
        ]} />
          ...
          <div className="mt-12">
            <Card className="p-8 mb-12">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <Link href="/calculators/live-earnings/" className="p-4 bg-neutral-50 rounded-lg hover:bg-neutral-100 transition-colors">
            ...
            <ToolExplanationSection
              ...
              relatedContent={[
                ...
                { title: 'LIVE Earnings Calculator', href: '/calculators/live-earnings/' },
                { title: 'Payout Calculator', href: '/calculators/payout/' },
              ]}
            />
