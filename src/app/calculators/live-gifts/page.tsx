...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://ttcalculator.net/featured/live-gifts-1600.webp', width: 1600, height: 1067, alt: 'TikTok LIVE Gifts Calculator — creator workspace scene illustrating the topic' }],
  },
};
