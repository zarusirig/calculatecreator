...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://ttcalculator.net/featured/brand-deal-rate-1600.webp', width: 1600, height: 1067, alt: 'TikTok Brand Deal Rate Calculator — creator workspace scene illustrating the topic' }],
  },
};
        ...
        <div className="container-custom">
          ...
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-body-md text-neutral-600 mt-4 max-w-2xl mx-auto">
              Learn negotiation strategies in our <Link href="/learn/brand-deals/" className="text-primary-600 hover:text-primary-700 underline">brand deal pricing guide</Link> or explore <Link href="/learn/brand-deal-rates-by-niche/" className="text-primary-600 hover:text-primary-700 underline">rates by niche</Link>.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <ToolExplanationSection
              ...
              relatedContent={[
                ...
                { title: 'Brand Deal Pricing Guide', href: '/learn/brand-deals/' },
              ]}
            />
