...
export const metadata: Metadata = {
  title: "TikTok Diamond Converter — Diamonds to USD Calculator",
  ...
  openGraph: {
    ...
    images: [{ url: 'https://ttcalculator.net/featured/diamond-converter-1600.webp', width: 1600, height: 1067, alt: 'TikTok Diamond Converter — creator workspace scene illustrating the topic' }],
  },
};
