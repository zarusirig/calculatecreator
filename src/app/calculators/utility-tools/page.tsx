...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://ttcalculator.net/featured/utility-tools-1600.webp', width: 1600, height: 1067, alt: 'TikTok Utility Tools — creator workspace scene illustrating the topic' }],
  },
};
