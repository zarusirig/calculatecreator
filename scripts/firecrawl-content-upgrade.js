...
const BASE_URL = 'https://ttcalculator.net';
...
async function extractFromFirecrawl(liveUrl) {
    ...
    const response = await fetch("https://api.firecrawl.dev/v1/extract", {
        ...
        body: JSON.stringify({
            urls: [liveUrl],
            prompt: "You are an expert SEO auditor correcting a page for ttcalculator.net based on recent audits. Fix spammy titles, generic descriptions, add direct answers, and missing FAQS. Extract the improved components.",
            schema: {
                type: "object",
                properties: {
                    seoOptimizedTitle: {
